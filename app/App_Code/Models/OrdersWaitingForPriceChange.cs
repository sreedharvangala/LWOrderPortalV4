...
{
	public enum OrdersWaitingForPriceChangeDataField
    {
    ...
    public partial class OrdersWaitingForPriceChangeModel : BusinessRulesObjectModel
    {
        ...
        public OrdersWaitingForPriceChangeModel()
        {
        }
        
        public OrdersWaitingForPriceChangeModel(BusinessRules r) : 
                base(r)
        {
        }
        ...
        public FieldValue this[OrdersWaitingForPriceChangeDataField field]
        {
            get
            {
