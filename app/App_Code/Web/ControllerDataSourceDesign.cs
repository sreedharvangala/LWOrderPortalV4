    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                var res = GetType().Assembly.GetManifestResourceStream(string.Format("Finsoft.Controllers.{0}.xml", DataController));
                if (res == null)
                	res = GetType().Assembly.GetManifestResourceStream(string.Format("Finsoft.{0}.xml", DataController));
                if (res != null)
