...
namespace Finsoft.Data
{
	public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                	res = ControllerConfigurationUtility.GetResourceStream(string.Format("Finsoft.controllers.{0}.xml", controller), string.Format("Finsoft.{0}.xml", controller));
                if (res == null)
                {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
            	t = typeof(Finsoft.Data.Controller);
            var res = ControllerConfigurationUtility.GetResourceStream(string.Format("Finsoft.Reports.{0}", name), string.Format("Finsoft.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                var config = Finsoft.Data.Controller.CreateConfigurationInstance(t, controller);
