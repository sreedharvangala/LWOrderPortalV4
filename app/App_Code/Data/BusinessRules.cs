...
namespace Finsoft.Data
{
    ...
    public class BusinessRulesBase : ActionHandlerBase, Finsoft.Data.IRowHandler, Finsoft.Data.IDataFilter, Finsoft.Data.IDataFilter2
    {
        ...
        protected virtual bool IsSystemSqlParameter(SqlText sql, string parameterName)
        {
            ...
            var systemParameterIndex = Array.IndexOf(SystemSqlParameters, nameWithoutMarker);
            ...
            foreach (var fileName in files.Keys)
            {
                ...
                if (permissionInfo.Success)
                	try
                    {
                        ...
                        permission.Text = ((string)(json["text"]));
                        permission.Description = ((string)(json["description"]));
