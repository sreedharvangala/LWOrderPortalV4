...
(function (root, doc, factory) {
    ...
    (function ($, undefined) {
        ...
        $.mobile.browser.oldIE = false;/* (function () {
            return false;
            //var v = 3,
    ...
    (function ($, window, document, undefined) {
        ...
        function mouseEventCallback(event) {
            ...
            if (event.type === 'mousedown' && event.which === 2 && $(event.target).closest('.app-scroller-vertical').length)
                return;
    ...
    */
    ...
    (function ($, window, undefined) {
        ...
        $(function () {
            ...
            // Changed by Serge
            $.mobile.defaultHomeScroll = 1;// ( !$.support.scrollTop || $.mobile.window.scrollTop() === 1 ) ? 0 : 1; //
