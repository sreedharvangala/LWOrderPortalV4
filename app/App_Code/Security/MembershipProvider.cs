...
namespace Finsoft.Security
{
    ...
    public class ApplicationMembershipProviderBase : MembershipProvider
    {
        ...
        static ApplicationMembershipProviderBase()
        {
            ...
            Statements[MembershipProviderSqlStatement.ChangePasswordQuestionAndAnswer] = "update Users set Column_users_passwordquestion_IsNotMapped = @PasswordQuestion, C" +
                "olumn_users_passwordanswer_IsNotMapped = @PasswordAnswer where UserName = @UserN" +
                "ame";
            ...
            Statements[MembershipProviderSqlStatement.GetAllUsers] = "\r\nselect \r\n   UserID UserID\r\n  ,UserName UserName\r\n  ,Email Email\r\nfrom Users \r\no" +
                "rder by UserName asc";
            Statements[MembershipProviderSqlStatement.GetNumberOfUsersOnline] = "select count(*) from Users where Column_users_lastactivitydate_IsNotMapped >= @Co" +
                "mpareDate";
            ...
            Statements[MembershipProviderSqlStatement.UpdateLastUserActivity] = "update Users set Column_users_lastactivitydate_IsNotMapped = @LastActivityDate wh" +
                "ere UserName = @UserName";
            Statements[MembershipProviderSqlStatement.GetUserByProviderKey] = "\r\nselect \r\n   UserID UserID\r\n  ,UserName Username\r\n  ,Email Email\r\nfrom Users \r\nw" +
                "here UserID = @UserID";
            Statements[MembershipProviderSqlStatement.UpdateUserLockStatus] = "update Users set Column_users_islockedout_IsNotMapped = @IsLockedOut where UserNa" +
                "me = @UserName";
            ...
            Statements[MembershipProviderSqlStatement.UpdateLastLoginDate] = "update Users set Column_users_lastlogindate_IsNotMapped = @LastLoginDate where Us" +
                "erName = @UserName";
        ...
        protected virtual SqlStatement CreateSqlStatement(MembershipProviderSqlStatement command)
        {
            ...
            sql.Name = ("Finsoft Application Membership Provider - " + command.ToString());
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(name))
            	name = "FinsoftApplicationMembershipProvider";
            if (string.IsNullOrEmpty(config["description"]))
            {
                config.Remove("description");
                config.Add("description", "Finsoft application membership provider");
            }
            ...
            if (string.IsNullOrEmpty(_validationKey) || _validationKey.Contains("AutoGenerate"))
            	_validationKey = "F336D0DED6306DB555DC3AC405FB10C68D8833A592E8B2DB0BA5A3606F6B5303BF8BFA8BB7959C734" +
                    "FCE0C48085D42A50CDA08117A92B9BCE3D68F2B54A2907E";
        }
