...
namespace Finsoft.Models
{
    ...
    public partial class ApprovalModel : BusinessRulesObjectModel
    {
        ...
        public ApprovalModel(BusinessRules r) : 
                base(r)
        {
        }
        ...
        public FieldValue this[ApprovalDataField field]
        {
            get
            {
