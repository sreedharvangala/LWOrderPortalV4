...
{
	public enum OrdersApprovedDataField
    {
    ...
    public partial class OrdersApprovedModel : BusinessRulesObjectModel
    {
        ...
        public OrdersApprovedModel()
        {
        }
        
        public OrdersApprovedModel(BusinessRules r) : 
                base(r)
        {
        }
        ...
        public FieldValue this[OrdersApprovedDataField field]
        {
            get
            {
