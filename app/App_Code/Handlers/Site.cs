...
namespace Finsoft.Handlers
{
    ...
    public class SiteBase : Finsoft.Web.PageBase
    {
        ...
        public static string Copyright
        {
            get
            {
                return "&copy; 2019 Finsoft. ^Copyright^All rights reserved.^Copyright^";
            }
        }
            ...
            if (contentInfo.TryGetValue("PageContent", out s) && (_pageContent != null))
            {
            	...
            	if (_isTouchUI)
                {
                    _pageContent.Text = "<div id=\"PageContent\" style=\"display:none\"><div data-app-role=\"page\">404 Not Foun" +
                        "d</div></div>";
                    this.Title = ApplicationServices.Current.Name;
                }
                else
