...
{
	public enum ApprovedOrdersDataField
    {
    ...
    public partial class ApprovedOrdersModel : BusinessRulesObjectModel
    {
        ...
        public ApprovedOrdersModel()
        {
        }
        
        public ApprovedOrdersModel(BusinessRules r) : 
                base(r)
        {
        }
        ...
        public FieldValue this[ApprovedOrdersDataField field]
        {
            get
            {
